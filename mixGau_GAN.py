...
g_sampler = Sampler(mean_B, std_B, num_B).mixgaussian()
...
for epoch in range(num_epochs):
	...
	if epoch % save_epoch == 0:
		...
		lm = sns.distplot(data_G, hist=False, color="g", kde_kws={"shade": True}, label = "real A")
		lm = sns.distplot(data_D, hist=False, color="m", kde_kws={"shade": True}, label = "real B")
		lm = sns.distplot(d_fake_data, hist=False, color="b", kde_kws={"shade": True}, label = "fake B")
		...
		outDir = "/Users/maureen/Documents/Python/simpleGAN/GAN/mixGau/" + str(epoch) +".png"
		plt.savefig(outDir)
